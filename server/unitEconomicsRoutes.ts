...
export function registerUnitEconomicsRoutes(app: Express) {
  app.get("/api/superadmin/unit-economics", requireSuperadmin, async (req, res) => {
  ...
  app.put("/api/superadmin/unit-economics/assumptions", requireSuperadmin, async (req, res) => {
  ...
  app.post("/api/superadmin/unit-economics/costs", requireSuperadmin, async (req, res) => {
  ...
  app.delete("/api/superadmin/unit-economics/costs/:id", requireSuperadmin, async (req, res) => {
  ...
  app.get("/api/superadmin/unit-economics/export.csv", requireSuperadmin, async (req, res) => {
    try {
