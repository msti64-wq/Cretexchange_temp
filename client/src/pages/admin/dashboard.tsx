        ...
        {trustReportLoading && autoApprovalStatsLoading ? (
          ...
          >
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              />
              <DashboardMetricCard
                title="Review Exceptions Needing Support"
                value={trustVerification.exceptions ?? "—"}
                helper="Additional review exceptions only; explicitly rejected activity is counted separately. Use the existing support and operational-report workflow."
                icon={ShieldAlert}
                toneClassName="bg-red-50 text-red-600 dark:bg-red-950/30 dark:text-red-300"
