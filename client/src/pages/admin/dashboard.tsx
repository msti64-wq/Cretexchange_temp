...
export default function AdminDashboard() {
  ...
  const currentPlatformReceivablesValue = billingReceivablesError ? "—" : formatCurrencyFromCents(billingReceivablesSummary?.platformFeesOwedCents ?? 0);
  const paidPlatformFeesValue = billingReceivablesError ? "—" : formatCurrencyFromCents(billingReceivablesSummary?.platformFeesPaidCents ?? 0);
  const totalPlatformFeesValue = billingReceivablesError ? "—" : formatCurrencyFromCents(billingReceivablesSummary?.platformFeesTotalCents ?? 0);
