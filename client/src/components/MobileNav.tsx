    ...
    switch (userRole) {
      ...
      case "super_admin":
        ...
        return [
          ...
          { path: "/locations", icon: Building, label: "Locations" },
          { path: "/financial-workspace", icon: ClipboardList, label: t("financialWorkspace.nav"), testIdLabel: "financial-workspace" },
          { path: "/payments", icon: DollarSign, label: t("legacyFinancial.nav.payments") },
          ...
          { path: "/fees", icon: FileText, label: t("financialVisibility.fees.title") },
          { path: "/service-accounts", icon: CreditCard, label: "Service Accounts" },
          { path: "/billing", icon: Clock, label: t("financialVisibility.billing.title") },
