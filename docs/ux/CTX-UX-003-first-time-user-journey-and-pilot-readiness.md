...
This document remains subordinate to the governing hierarchy: [Platform Vision](../vision/platform-vision.md), [Platform Strategy](../vision/platform-strategy.md), [Project Context](../project/project-context.md), [Platform Standards](../standards/cretexchange-platform-standards.md), applicable [CTX-ARCH documents](../architecture/README.md), [Product Decisions](../product/product-decisions.md), and the [Development Protocol](../development-protocol.md). In particular, [Canonical Driver Settlement Rail (embedded catalog entry)](../product/product-decisions.md#pd-045---canonical-driver-settlement-rail) (PD-045) and [CTX-ARCH-006](../architecture/driver-incentive-and-financial-settlement-architecture.md) continue to govern settlement boundaries; this document does not alter them.
