...
| CTX-ARCH-008 | [Production Database Migration Discovery and Requirements](./CTX-ARCH-008-production-database-migration-discovery-and-requirements.md) | Repository-grounded discovery, requirements, options, risks, and decision register for a future controlled migration architecture | Discovery package; not an approved implementation architecture |
