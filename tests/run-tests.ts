...
test("owner billing dry-run preview reads driver tips from washout activity amounts", () => {
  const preview = buildOwnerWashoutBillingPreview({
    ...
    washouts: [
      { id: "activity_1", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 99, locationDriverTipRate: 99 },
      { id: "activity_2", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 99, locationDriverTipRate: 99 },
      { id: "activity_3", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 99, locationDriverTipRate: 99 },
    ],
    customerId: "cus_123",
...
test("owner billing dry-run preview with seven approved activity amounts at one cent each totals seven cents", () => {
  const preview = buildOwnerWashoutBillingPreview({
    ...
    washouts: [
      { id: "f3805985-6db4-4cf8-81a2-24fc3a41a9cb", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
      { id: "3042b4cb-8e1a-4cbb-a38a-569879aef6fa", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
      { id: "d66f29bb-0515-4a2e-bce1-c8f09083bde5", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
      { id: "01a9046e-fe73-4443-b806-d44b0895a9de", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
      { id: "057351bf-c480-4b55-a6cb-635037655561", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
      { id: "5ca7dc66-1c34-4530-919e-c17ea43237f8", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
      { id: "77323db3-be40-4923-aa70-615d2f70b871", ownerId: "owner_1", driverId: "driver_1", driverStripeAccountId: "acct_1TgHLRLpQOyKFyJs", platformFeeCents: 500, activityAmount: "0.01", paymentDriverTipCents: 0, locationDriverTipRate: 0 },
    ],
    customerId: "cus_123",
    paymentMethodId: "pm_123",
  });
  ...
  await withPatchedStorage(
    {
      ...
      getSystemSettings: async () => ({ platformWashoutFee: "5.00" }),
      getApprovedWashoutsForOwnerBilling: async () => ([
        { activityId: "3042b4cb-8e1a-4cbb-a38a-569879aef6fa", ownerId: "owner_1", driverId: "driver_1", locationId: "location_1", locationName: "Yard A", activityAmount: "0.01", activityFeeCentsPlatform: 500, locationDriverTipRate: 99, paymentTipAmountCents: 0 },
        { activityId: "d66f29bb-0515-4a2e-bce1-c8f09083bde5", ownerId: "owner_1", driverId: "driver_1", locationId: "location_1", locationName: "Yard A", activityAmount: "0.01", activityFeeCentsPlatform: 500, locationDriverTipRate: 99, paymentTipAmountCents: 0 },
        { activityId: "01a9046e-fe73-4443-b806-d44b0895a9de", ownerId: "owner_1", driverId: "driver_1", locationId: "location_1", locationName: "Yard A", activityAmount: "0.01", activityFeeCentsPlatform: 500, locationDriverTipRate: 99, paymentTipAmountCents: 0 },
        { activityId: "057351bf-c480-4b55-a6cb-635037655561", ownerId: "owner_1", driverId: "driver_1", locationId: "location_1", locationName: "Yard A", activityAmount: "0.01", activityFeeCentsPlatform: 500, locationDriverTipRate: 99, paymentTipAmountCents: 0 },
        { activityId: "5ca7dc66-1c34-4530-919e-c17ea43237f8", ownerId: "owner_1", driverId: "driver_1", locationId: "location_1", locationName: "Yard A", activityAmount: "0.01", activityFeeCentsPlatform: 500, locationDriverTipRate: 99, paymentTipAmountCents: 0 },
        { activityId: "77323db3-be40-4923-aa70-615d2f70b871", ownerId: "owner_1", driverId: "driver_1", locationId: "location_1", locationName: "Yard A", activityAmount: "0.01", activityFeeCentsPlatform: 500, locationDriverTipRate: 99, paymentTipAmountCents: 0 },
      ]),
