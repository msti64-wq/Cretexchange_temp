...
test("Driver Intelligence is dashboard-scoped, self-service, and operational only", async () => {
  ...
  assert.match(page, /driver\.intelligence\.lifetimeVerified/);
  assert.match(page, /driver\.intelligence\.checkInUpload/);
  assert.match(page, /driver\.intelligence\.activityTrends/);
  assert.match(page, /driver\.intelligence\.achievements/);
  assert.match(page, /\/api\/drivers\/achievements/);
  assert.match(page, /driver\.intelligence\.nextAchievement/);
  assert.match(page, /driver\.intelligence\.earnedAchievements/);
  assert.match(page, /earnedAt/);
